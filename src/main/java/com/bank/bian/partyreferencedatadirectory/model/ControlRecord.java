package com.bank.bian.partyreferencedatadirectory.model;
...
/**
 * The BIAN control record for this service domain: "Party Reference Data Directory Entry".
 *
 ...
 * to its asset type (Party Reference Data). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Party Reference Data Directory Entry";
